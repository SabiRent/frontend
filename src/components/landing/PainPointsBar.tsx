...
export default function PainPointsBar() {
  return (
    <div className="mx-auto -mt-25 max-w-8xl w-full px-6 mb-17">
      <div className="grid grid-cols-1 gap-6 h-[108px] rounded-3xl border border-[rgba(0,0,0,0.25)] bg-white px-8 py-6 shadow-[0_0_15px_rgba(0,0,0,0.06),0_30px_10px_-25px_rgba(0,0,0,0.15)] sm:grid-cols-2 lg:grid-cols-4">
        {PAIN_POINTS.map((point, index) => (
          <div key={index} className="flex items-center gap-6">
            ...
            <p className="text-mb font-semibold w-[316px] h-[48px] text-[rgba(30,58,95,1)]">
              {point.text}
            </p>
          </div>
        ))}
