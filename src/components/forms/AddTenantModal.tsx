const propertyUnits: Record<string, string[]> = {
  "Prince & Princess": ["Unit 1A", "Unit 1B", "Unit 2A", "Unit 2B"],

  "Sunshine Apartments": ["Flat 101", "Flat 102", "Flat 201"],

  "Peace Estate": ["Block A", "Block B", "Block C"],

  "Hillcrest Apartments": ["Unit A1", "Unit A2"],

  "Cedar Court": ["Flat 1", "Flat 2"],

  "Maple Heights": ["Apartment 12", "Apartment 15"],

  "Emerald Court": ["Suite 1", "Suite 2"],

  BluCabana: ["Villa 1", "Villa 2"],
};
...
const EditTenantModal = ({ isOpen, onClose }: AddTenantModalProps) => {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                ...
                setSelectedUnit(""); // Reset unit whenever property changes
              }}
              className="h-[40px] w-full rounded-lg border border-[#A8ABAB] px-4 outline-none focus:border-[#167589]"
            >
          ...
          <div>
            ...
            <select
              ...
              className="h-[40px] w-full rounded-lg border border-[#A8ABAB] px-4 outline-none disabled:bg-white"
            >
              <option value="">
              ...
              {selectedProperty &&
                propertyUnits[selectedProperty]?.map((unit) => (
